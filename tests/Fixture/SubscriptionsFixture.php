...
class SubscriptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subscription' => ['type' => 'json', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'user_id' => ['type' => 'string', 'length' => 36, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-09-29 23:09:23',
                'modified' => '2020-09-29 23:09:23',
            ],
        ];
        parent::init();
    }
