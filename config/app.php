...
return [
  ...
  'App' => [
    ...
    //Massimoi: Attenzione questa è la lingua di default dell'applicazione, per ora per TUTTI i siti
    //TODO: Valutare se spostare in settings (nel caso serva avere un sito con il default in inglese)
    'defaultLocale' => env('APP_DEFAULT_LOCALE', 'it'),
    //'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'UTC'),
    'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'Europe/Rome'),
    //Bisogna mettere false per mantenere compatibilità con CakePHP <4
  ...
  /*
     ...
     */
  'Security' => [
    'salt' => env('SECURITY_SALT', 'd0cf6c0d75e67a90b57be9497675fd2673c1ff65d1f64a63daa04b8b9334d363'),
  ],
  ...
  'Cache' => [
    ...
    '_cake_core_' => [
      ...
      'path' =>  CACHE . Configure::read('sitedir') . 'persistent' . DS,
      'serialize' => true,
      'duration' => '+1 years',
    ...
    '_cake_model_' => [
      ...
      'path' =>  CACHE . Configure::read('sitedir') . 'models' . DS,
      'serialize' => true,
      'duration' => '+1 years',
    ...
    'img' => [
      'className' => 'File',
      'prefix' => 'img_',
      'path' =>  CACHE . Configure::read('sitedir') . 'gallery' . DS,
      'serialize' => true,
      'duration' => '+1 years',
      'url' => env('CACHE_CAKEMODEL_URL', null),
    ],
  ...
  /*
     ...
     */
  //Configurazione in settings.php
  /*   'EmailTransport' => [
    'Debug' => [
      'className' => 'Debug',
    ],
