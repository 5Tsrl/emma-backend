...
return [
  ...
  'FrontendUrl' =>  env('GEOCODING_URL', false),
  'MailAdmin' =>  env('GEOCODING_URL', false),
  'MailAgenzia' =>  env('GEOCODING_URL', false),
  'MailLogo' =>  env('GEOCODING_URL', false),
  ...
  'EmailTransport' => [
    'default' => [
      'host' => env('MYSQL_USER', false),
      'port' => 587,
      'username' => env('MYSQL_USER', false),
      'password' => env('MYSQL_USER', false),
      'className' => 'Smtp',
      'tls' => true,
    ],
  ],
   ...
   */
  'Coworking' => [
    'types' => ["Sala reunioni","Ufficio dedicato","postazione condivisa"],
  ],
];
